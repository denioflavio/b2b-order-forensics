...
create or replace package body bf_order_pkg as
 ...
 begin
  ...
  select nvl(max(attempt_no),0)+1 into l_attempt from bf_order where request_hash=p_key;
 ...
 begin
  ...
  begin
   ...
   bf_log_pkg.log_access(107,to_number(v('APP_PAGE_ID')),p_session,'PLACE_ORDER',p_user,null,l_order.correlation_id,p_order);
